                    ...
                    <Col>
                        ...
                        <Form className="ordering">
                            <select name="orderby" className="orderby select2" onChange={(e) => this.props.sortValue(e.target.value)} tabIndex={-1} aria-hidden="true">
                                <option value=" " selected="selected">Bütün məhsullar</option>
                                <option value="NewProduct">Ən son məhsullar</option>
                                <option value="Pricehigh">Qiymət: Bahadan Ucuza</option>
                                <option value="Pricelow">Qiymət: Ucuzdan Bahaya</option>
                            </select>
                        </Form>
                    </Col>
                </Row>
