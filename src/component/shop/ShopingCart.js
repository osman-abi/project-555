...
class ShopingCart extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            Adress1: "Baki şəh., Nərimanov rayonu",
            Adress2: "Arndurm",
            Adress3: "UK"
        }
                                        ...
                                        <Table className="cart-table">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th className="product-subtotal">Cəmi</th>
                                                </tr>
                                                ...
                                                {this.ReadCartItems().map((CartItem, index) => (
                                                    <tr>
                                                        ...
                                                        <td className="product-price">
                                                            {CartItem.Rate.toLocaleString(navigator.language, { minimumFractionDigits: 0 })} AZN
                                                        </td>
                                                        ...
                                                        <td className="product-subtotal">
                                                            {(CartItem.Rate * CartItem.Qty).toLocaleString(navigator.language, { minimumFractionDigits: 0 })} AZN
                                                        </td>
                                                    </tr>
                                        ...
                                        <Table cellspacing="0" className="shop_table shop_table_responsive">
                                            <tbody>
                                                <tr className="cart-subtotal">
                                                    <th>Cəmi</th>
                                                    <td data-title="Subtotal"><span className="woocs_special_price_code"><span className="Price-amount amount"><span className="Price-currencySymbol"></span> {this.ReadCartItems().reduce((fr, CartItem) => fr + (CartItem.Qty * CartItem.Rate), 0).toLocaleString(navigator.language, { minimumFractionDigits: 0 })} AZN </span></span>
                                                    </td>
                                                </tr>
 ...
 */}
                            ...
                            <a className="btn btn-primary" href="/sidebar-without-lazyload">Mağazaya qayıt</a>
                            </div>
                        }
                    </Container>
                </div>
